        ...
        <div class="row">
            ...
            <div class="col-lg-6" style="min-height: 500px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100" src="{{asset('storage/aboutus/'.$aboutus->image)}}" style="object-fit: cover;">
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-2">
                <div class="team-item bg-white mb-4">
                    <div class="team-img position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="{{asset('storage/team/'.$team->image)}}" style="height: 200px">
                    ...
                    <div class="text-center py-4">
                        <h5 class="text-truncate text-capitalize">{{$team->name}}</h5>
