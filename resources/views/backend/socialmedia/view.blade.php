            ...
            <div class="row mb-2">
                <div class="col-sm-4">
                    <a href="{{route('create.socialmedia')}}" class="btn btn-danger mb-2"><i
                            class="fa fa-plus-circle mr-2"></i> Add Socialmedia</a>
                </div>
            </div>
                ...
                <table class="table">
                    ...
                    <tbody id="tablecontents">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('edit.socialmedia',$socialmedia->id)}}" title="Edit"><i
                                        class="fa fa-edit "></i></a>
                                <a href="{{route('delete.socialmedia',$socialmedia->id)}}"
