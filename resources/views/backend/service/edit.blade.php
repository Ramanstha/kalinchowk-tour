            ...
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <form action="{{route('update.service',$data->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="col-md-12">
                            <input type="icon" class="form-control" name="icon" value="{{$data->icon}}">
                            @error('icon')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="col-md-12">
                            <textarea class="form-control" name="description" id="description" rows="3" value="{!!$data->description!!}">{!!$data->description!!}</textarea>
                            @error('description')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
