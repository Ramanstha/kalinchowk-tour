                ...
                <form action="{{route('update.testimonial',$data->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-5 col-sm-12 mb-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <img class="mt-2" src="{{asset('storage/testimonial/'.$data->image)}}" height="100" width="100" alt="">
                            @error('image')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="col-md-12">
                            <textarea class="form-control" name="message" id="message" rows="3" value="{!!$data->message!!}">{!!$data->message!!}</textarea>
                            @error('message')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
