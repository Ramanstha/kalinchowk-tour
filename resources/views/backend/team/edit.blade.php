    ...
    <div class="row g-4">
        <div class="col-sm-12 col-xl-12">
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <form action="{{route('update.team',$data->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-5 col-sm-12 mb-3">
                            <label class="col-form-label col-md-4">Designation <span class="text-danger">*</span></label>
                            <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class=" col-md-5 col-sm-12 mb-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <img class="mt-2" src="{{asset('storage/team/'.$data->image)}}" height="100" width="100" alt="">
                                @error('image')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
